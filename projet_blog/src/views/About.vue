  ...
  <div class="about">
    <div class="container">
      ...
      <div class="row text-center p-5">
        ...
        <div class="col-sm-3" style=""><h4>Anaïs</h4></div>
        <div class="col-sm-3" style=""><h4>Brendan</h4></div>
        <div class="col-sm-3" style=""><h4>Tristan</h4></div>
      </div>
      ...
      <p>
        ...
        ut labore et dolore magnam aliquam quaerat voluptatem. <br> 
        Ut enim ad minima veniam, 
        quis nostrum exercitationem ullam corporis suscipit laboriosam, 
        nisi ut aliquid ex ea commodi consequatur? <br> <br> 
        ...
        qui officia deserunt mollitia animi, id est laborum et dolorum fuga. <br> 
        Et harum quidem rerum facilis est et expedita distinctio. <br> 
        Nam libero tempore, cum soluta nobis est eligendi optio, cumque nihil impedit, 
        quo minus id, quod maxime placeat, facere possimus, omnis voluptas assumenda est, 
        omnis dolor repellendus. <br> 
